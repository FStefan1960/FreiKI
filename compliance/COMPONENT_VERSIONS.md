...
| Beszel Hub | 0.18.7 | `henrygd/beszel:0.18.7` | (Digest nach erstem Pull auf der Instanz nachtragen) | MIT | [Source](https://github.com/henrygd/beszel/tree/v0.18.7) · [Lizenz](https://github.com/henrygd/beszel/blob/main/LICENSE) |
| Beszel Agent | 0.18.7 | `henrygd/beszel-agent:0.18.7` / bei NVIDIA: `henrygd/beszel-agent-nvidia:0.18.7` | (Digest nach erstem Pull auf der Instanz nachtragen) | MIT | [Source](https://github.com/henrygd/beszel/tree/v0.18.7) · [Lizenz](https://github.com/henrygd/beszel/blob/main/LICENSE) |
