...
Im Tab Verlauf in der Seitenleiste stehen alle gespeicherten Unterhaltungen, neueste zuerst, mit Titel (aus der ersten Frage abgeleitet), Werkzeug und Datum. Klick öffnet die Unterhaltung wieder dort, wo sie aufgehört hat. Der Papierkorb-Button an einer Zeile löscht nur diese eine Unterhaltung, nach Rückfrage. Enthielt eine Antwort möglicherweise schützenswerte Inhalte (siehe „Prüft KorKI sensible Inhalte?“), wird sie im Verlauf durch einen Platzhalter ersetzt statt gespeichert.
