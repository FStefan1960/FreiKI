        ...
        messages: [
          {
            ...
            content: 'Du bekommst den Inhalt eines gescannten QR-/Barcodes und sein erkanntes Format. '
              ...
              + '- "ean_lookup": NUR wenn das Format EAN_8, EAN_13, UPC_A oder UPC_E ist. '
              + 'Bei allen anderen Formaten (z.B. CODE_39, CODE_93, CODE_128, ITF, CODABAR) NICHT ean_lookup wählen, '
              + 'auch wenn der Inhalt rein numerisch aussieht - dafür ist "web_lookup" zuständig\n'
